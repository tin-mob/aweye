...
OptionsDialog::OptionsDialog(wxWindow* parent,wxWindowID id)
{
	...
	workingTextCtrl = new wxTextCtrl(this, ID_TEXTCTRL2, wxString::Format(wxT("%i"), config->getWorkLength()), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL2"));
	...
	pauseTextCtrl = new wxTextCtrl(this, ID_TEXTCTRL3, wxString::Format(wxT("%i"), config->getPauseLength()), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL3"));
	...
	reminderTextCtrl = new wxTextCtrl(this, ID_TEXTCTRL4, wxString::Format(wxT("%i"), config->getRemFreq()), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL4"));
	...
	checkTextCtrl = new wxTextCtrl(this, ID_TEXTCTRL5, wxString::Format(wxT("%i"), config->getCheckFreq()), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL5"));
